...
| Treinamento | Capacitação técnica | Cursos online e tutoriais utilizados no aprendizado de tecnologias | 0,00 (acesso pela internet) |
...
|---|---|---|---|---|
| Estudo do tema + Levantamento de requisitos | — | 4 dias | — | Pesquisa inicial, definição de escopo e levantamento preliminar de dados |
| Planejamento inicial + Cronograma + EAP | — | 3 dias | — | Estruturação do plano de projeto |
| Design Sprint + Artefatos generalistas + Modelagem BPMN | — | 1 semana | — | Criação de protótipos, wireframes, modelagem de processos |
| Diagramas UML (Estático, Dinâmico, Organizacional, Casos de Uso) | — | 4 semanas | — | Modelagem de estrutura, comportamento e organização do sistema |
| Estudo e aplicação de padrões de projeto | — | 1 semana | — | Pesquisa e escolha dos padrões mais adequados |
| Padrões Criacional, Estrutural e Comportamental | — | 2 semanas e meia | — | Implementação dos padrões e simulação de exemplos no sistema |
| Revisão geral e ajustes finais | — | 1 semana | — | Revisão de artefatos, ajustes técnicos e refinamento final |
| Apresentação final e documentação | — | 1 semana | — | Preparação de slides, documentação completa e encerramento do projeto |
...
| R2 | Imbróglio em uma fase específica do projeto | Média | Alto | Dividir as atividades em microtarefas para fácil redistribuição | Revisar escopo da etapa e buscar apoio técnico ou teórico |
...
| R12 | Falta de energia ou instabilidade na conexão | Baixa | Média | Trabalhar com arquivos offline e salvar em serviços na nuvem | Aguardar retorno e adiantar tarefas manuais ou de documentação |
